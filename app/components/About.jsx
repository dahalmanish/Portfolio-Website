      ...
      >
        ...
        >
            ...
            transition={{duration: 0.6,delay: 0.8}}>
                <p className='mb-10 max-w-2xl font-Ovo'>I am an aspiring developer eager to learn about web development and gain experience in working in different projects.
                </p>
                <motion.ul
                initial={{opacity: 0}}
                whileInView={{opacity: 1}}
                transition={{duration: 0.8,delay: 1}}
                className='grid grid-cols-1 sm:grid-cols-3 gap-6 amx-w-2xl'>
